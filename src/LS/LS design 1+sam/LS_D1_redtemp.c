...
//print keys
    ...
    int unique_key=0,compromised_keys[200000];;
    ...
    for(time=0; time<100; time++)                             //runtime
    {
        ...
        for(a1=0;a1<200000;a1++)
        {
            compromised_keys[a1]=0;
        }
    ...
    //V(s) calculation
    int unique_key_set[500000];
    for(a1=0;a1<50000;a1++)     //initialize
    {
        unique_key_set[a1]=-1;
    }
    ...
    for(a1=0;a1<count1;a1++)
    {
        unique_key_set[compromised_keys[a1]]=compromised_keys[a1];
    }
    /*for(a1=0;a1<no_of_node;a1++)
    {
        printf("%d,",unique_key_set[a1]);
    }*/
    ...
    for(a1=0;a1<no_of_node;a1++)
    {
        ...
        for(a2=0;a2<k;a2++)
        {
            ...
            {
                if(key_set_stat[a1][a2]==unique_key_set[a3])
                    count_vs++;
            }
        }
        if(count_vs==k)
    ...
    float finalvs=(float)vs/no_of_node;
    printf("\nvs::%f",finalvs);
